    ...
    const res = await fetch("https://api.groq.com/openai/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
           content: "You are a clinical AI. Respond ONLY with valid JSON exactly like this: {\"classification\": \"string\", \"riskScore\": number (MUST be an integer between 1 and 10), \"confidence\": number, \"details\": \"string\", \"symptoms\": [\"string\"]}"
          },
          {
            role: "user",
            content: [
